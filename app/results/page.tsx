...
export default function ResultsPage() {
  ...
  const { data: results, isLoading: resultsLoading } = useStudentResults(student?.id);
      ...
      <div className="container mx-auto py-10 pt-24 space-y-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-slate-500">Enter scores, classify performance, and manage result publication.</p>
          </div>
          <div className="flex items-center gap-2 bg-blue-50 px-4 py-2 rounded-xl border border-blue-100">
             <Info className="h-4 w-4 text-blue-600" />
             <p className="text-xs font-semibold text-blue-700">Financial status automatically controls visibility</p>
          </div>
        </div>
             ...
             <CardContent className="pt-6">
                <div className="flex items-center gap-4">
                   ...
                   <div>
                      ...
                      <p className="text-xs font-bold text-slate-400 uppercase">Graded Students</p>
                   </div>
                </div>
             </CardContent>
           </Card>
  ...
  return (
    <div className="container mx-auto py-10 pt-24 max-w-5xl space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-slate-900">Academic Marksheet</h1>
          <p className="text-slate-500">Official record of your assessment performance and classifications.</p>
        </div>
        ...
        <Card className="border-dashed border-slate-200 bg-slate-50/50">
          <CardContent className="flex flex-col items-center justify-center py-20 text-center">
             ...
             <p className="text-slate-500 max-w-xs mt-1">
               We couldn&apos;t find any academic records associated with your student ID.
             </p>
          </CardContent>
        </Card>
      )}
